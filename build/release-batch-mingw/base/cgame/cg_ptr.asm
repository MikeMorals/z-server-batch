...
;21:*/
;22:
;23:// cg_ptr.c -- post timeout restoration handling
;24:
;25:
;26:#include "cg_local.h"
;27:
;28:#define PTRC_FILE  "ptrc.cfg"
;29:
;30:/*
;31:===============
;32:CG_ReadPTRCode
;33:
;34:Read a PTR code from disk
;35:===============
;36:*/
;37:int CG_ReadPTRCode( void )
;38:{
line 44
;39:  int           len;
;40:  char          text[ 16 ];
...
;42:
;43:  // load the file
;44:  len = trap_FS_FOpenFile( PTRC_FILE, &f, FS_READ );
ADDRGP4 $100
ARGP4
ADDRLP4 20
ARGP4
...
line 49
;47:
;48:  // should never happen - malformed write
;49:  if( len >= sizeof( text ) - 1 )
ADDRLP4 0
INDIRI4
CVIU4 4
CNSTU4 15
...
;61:CG_WritePTRCode
;62:
;63:Write a PTR code to disk
;64:===============
;65:*/
;66:void CG_WritePTRCode( int code )
;67:{
line 71
;68:  char          text[ 16 ];
;69:  fileHandle_t  f;
;70:
;71:  Com_sprintf( text, 16, "%d", code );
ADDRLP4 0
ARGP4
CNSTI4 16
ARGI4
...
;72:
;73:  // open file
;74:  if( trap_FS_FOpenFile( PTRC_FILE, &f, FS_WRITE ) < 0 )
ADDRGP4 $100
ARGP4
ADDRLP4 16
ARGP4
...
;76:
;77:  // write the code
;78:  trap_FS_Write( text, strlen( text ), f );
ADDRLP4 0
ARGP4
ADDRLP4 24
ADDRGP4 strlen
