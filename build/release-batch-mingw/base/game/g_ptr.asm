...
;35:===============
;36: */
;37:static qboolean G_CheckForUniquePTRC(int code) {
line 40
;38:  int i;
;39:
;40:  if (code == 0)
...
LABELV $87
line 44
;44:    if (connections[ i ].ptrCode == code)
CNSTI4 24
ADDRLP4 0
INDIRI4
MULI4
...
;51:/*
;52:===============
;53:G_UpdatePTRConnection
;54:
;55:Update the data in a connection record
;56:===============
;57: */
;58:void G_UpdatePTRConnection(gclient_t *client) {
line 59
;59:  if (client && client->pers.connection) {
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
EQU4 $95
line 60
;60:    client->pers.connection->clientTeam = client->pers.teamSelection;
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNI4
line 61
;61:    client->pers.connection->clientCredit = client->pers.credit;
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNI4
line 62
;62:    client->pers.connection->clientScore = client->pers.score;
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
;66:/*
;67:===============
;68:G_GenerateNewConnection
;69:
;70:Generates a new connection
;71:===============
;72: */
;73:connectionRecord_t *G_GenerateNewConnection(gclient_t *client) {
line 74
;74:  int code = 0;
ADDRLP4 4
CNSTI4 0
...
;75:  int i;
;76:
;77:  // this should be really random
;78:  srand(trap_Milliseconds());
ADDRLP4 8
...
line 82
;79:
;80:  // there is a very very small possibility that this
;81:  // will loop infinitely
;82:  do {
line 83
;83:    code = rand();
ADDRLP4 12
...
ASGNI4
line 84
;84:  } while (!G_CheckForUniquePTRC(code));
LABELV $99
ADDRLP4 4
INDIRI4
ARGI4
...
LABELV $101
line 88
;87:    //found an unused slot
;88:    if (!connections[ i ].ptrCode) {
CNSTI4 24
ADDRLP4 0
INDIRI4
MULI4
...
ASGNI4
line 90
;90:      connections[ i ].clientNum = client->ps.clientNum;
CNSTI4 24
ADDRLP4 0
INDIRI4
MULI4
...
ASGNI4
line 91
;91:      client->pers.connection = &connections[ i ];
ADDRFP4 0
INDIRP4
CNSTI4 640
ADDP4
...
ASGNP4
line 92
;92:      G_UpdatePTRConnection(client);
ADDRFP4 0
INDIRP4
ARGP4
...
pop
line 93
;93:      client->pers.connection->clientEnterTime = client->pers.enterTime;
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
;102:/*
;103:===============
;104:G_FindConnectionForCode
;105:
;106:Finds a connection for a given code
;107:===============
;108: */
;109:connectionRecord_t *G_FindConnectionForCode(int code) {
line 112
;110:  int i;
;111:
;112:  if (code == 0)
...
LABELV $112
line 116
;116:    if (connections[ i ].ptrCode == code)
CNSTI4 24
ADDRLP4 0
INDIRI4
MULI4
...
;123:/*
;124:===============
;125:G_ResetPTRConnections
;126:
;127:Invalidate any existing codes
;128:===============
;129: */
;130:void G_ResetPTRConnections(void) {
line 131
;131:  memset(connections, 0, sizeof ( connectionRecord_t) * MAX_CLIENTS);
ADDRGP4 connections
ARGP4
CNSTI4 0
ARGI4
